            ...
            Object.keys(marketData).forEach(crop => {
                ...
                card.innerHTML = `
                    <div class="price-header">
                        <img src="https://images.unsplash.com/photo-${getCropImageId(crop)}?w=100&h=100&fit=crop&crop=center" 
                             alt="${data.name}" class="crop-icon">
        ...
        // Get appropriate crop image IDs
        function getCropImageId(crop) {
            const imageIds = {
                wheat: '1574323347407-f5e1ad6d020b',
                rice: '1536304993881-ff6e9eefa2a6',
                sugarcane: '1571091718767-18b5b1457add',
                barley: '1569976710208-b52b1dd58d85',
                bajra: '1595855759920-86582396756a',
                cotton: '1463871273229-dd4cb7dc563d'
            };
            return imageIds[crop] || '1574323347407-f5e1ad6d020b';
        }

        // Create enhanced line charts with animations
                            ...
                            callbacks: {
                                ...
                                afterLabel: function(context) {
                                    const previousValue = context.dataIndex > 0 ? 
                                        data.data[context.dataIndex - 1] : context.parsed.y;
        ...
        function selectCrop(crop) {
            ...
            // Scroll to the corresponding chart
        ...
        function filterByMarket(market) {
            if (market === 'all') {
                ...
                // Apply market-specific pricing (simulation)
        ...
        function updateTimeRange(range) {
            ...
            Object.keys(marketData).forEach(crop => {
                ...
                // Generate appropriate data for the time range
        ...
        function generateTimeRangeData(range, currentPrice) {
            ...
            for (let i = 0; i < points; i++) {
                ...
                data.push(Math.max(price, currentPrice * 0.8)); // Minimum 80% of current price
            }
        ...
        function simulateMarketUpdate() {
            Object.keys(marketData).forEach(crop => {
                const data = marketData[crop];
                const volatility = data.current * 0.02; // 2% volatility
        ...
        function exportData() {
            const csvData = [];
            csvData.push(['Crop', 'Current Price (₹/quintal)', 'Previous Price', 'Change', 'Change %', '7-Day High', '7-Day Low']);
        ...
        console.log('   Alt+R: Refresh data');
        console.log('   Alt+E: Export data');
        console.log('   Alt+1: 1 Day view');
        console.log('   Alt+7: 7 Day view');